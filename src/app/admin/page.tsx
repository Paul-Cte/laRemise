                    ...
                    {categories.map(cat => (
                      <li key={cat.id} className="group flex justify-between items-center p-3.5 bg-gray-50 hover:bg-white border border-transparent hover:border-gray-200 rounded-xl transition-all duration-300">
                        ...
                        <form action={async (formData: FormData) => {
                          ...
                          <button type="submit" className="opacity-0 group-hover:opacity-100 p-2 text-gray-400 hover:text-red-500 hover:bg-red-50 rounded-lg transition-all duration-300" title="Supprimer">
